...
pen.hideturtle()
pen.goto(0, 260)
pen.write(" Azimov: 0    Suborov: 0 ", align="center",
...
while True:
    ...
    if ball.xcor() > 690:
        ...
        pen.clear()
        pen.write("Azimov: {}
                  Suborov: {}".format(score_azimov,
                  score_suborov), align="center", font=("Arial", 24, "normal"))
    ...
    if (ball.xcor() > 640 and ball.xcor() < 650) and (ball.ycor() <
       paddle_suborov.ycor() + 100 and ball.ycor() >
       paddle_suborov.ycor() - 100):
        ball.setx(640)
        ball.dx *= -1

    if (ball.xcor() < -640 and ball.xcor() > -650) and (ball.ycor() <
       paddle_azimov.ycor() + 100 and ball.ycor() >
       paddle_azimov.ycor() - 100):
        ball.setx(-640)
        ball.dx *= -1